...
module.exports = validateFirebaseIdToken = async (req, res, next) => {
  ...
  if (
    ...
    res.status(403).send("Pirmas Unauthorized");
    return;
  }
  ...
  if (
    ...
    // No cookie
    res.status(403).send("Antras Unauthorized");
    return;
  }
  ...
  try {
    ...
    res.status(403).send("Trecias Unauthorized");
    console.log("Trecias Unauthorized")
    return;
  }
};